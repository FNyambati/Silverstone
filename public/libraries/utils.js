(function() {
  ...
  function qa(a, b) {
    for (var c = fa(a.e()), d = 0; d < c.length; d++) {
      ...
      if (null != b.c[f]) {
        ...
        var g = 11 == e.p || 10 == e.p;
        if (e.da)
          for (var e = x(b, f) || [], h = 0; h < e.length; h++) oa(a, f, g ? e[h].clone() : e[h]);
        else e = x(b, f), g ? (g = x(a, f)) ? qa(g, e) : w(a, f, e.clone()) : w(a, f, e)
      }
    }
  }
  k.clone = function() {
  ...
  */
  ...
  I.prototype.ca = function(a, b) {
    if (11 == a.p || 10 == a.p) return b instanceof t ? b : this.$(a.na.e(), b);
  ...
  */
  ...
  function Q(a, b) {
    for (var c = new r, d, e = a.length, f = 0; f < e; ++f) d = a.charAt(f), d = b[d.toUpperCase()], null != d && c.append(d);
    return c.toString()
  }
  ...
  M.prototype.format = function(a, b) {
    ...
    var e = T(this, c, U(c)),
      f;
    f = null != a.c[3] && 0 != a.getExtension().length ? 3 == b ? ";ext=" + a.getExtension() : null != e.c[13] ? v(e, 13) + y(a, 3) : " ext. " + y(a, 3) : "";
    a: {
      for (var e = 0 == (x(e, 20) || []).length || 2 == b ? x(e, 19) || [] : x(e, 20) || [], g, h = e.length, l = 0; l < h; ++l) {
        g = e[l];
        var n = z(g, 3);
        if (0 == n || 0 == d.search(v(g, 3, n - 1)))
          if (n = new RegExp(v(g, 1)), P(n, d)) {
            e = g;
            break a
          }
      }
    ...
    null != e && (h = e, e = y(h, 2), g = new RegExp(v(h, 1)), y(h, 5), l = "", h = y(h, 4), l = 2 == b && null != h && 0 < h.length ? d.replace(g, e.replace(Ca, h)) : d.replace(g, e), 3 == b && (l = l.replace(RegExp("^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]+"), ""), l = l.replace(RegExp("[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e]+", "g"), "-")), d = l);
    return Ia(c, b, d, f)
  };
  ...
  function S(a) {
    var b = "" + v(a, 2);
    return null != a.c[4] && v(a, 4) ? Array(y(a, 8) + 1).join("0") + b : b
  }
  ...
  function W(a, b) {
    return X(a, v(b, 1)) ? X(a, v(b, 5)) ? 4 : X(a, v(b, 4)) ? 3 : X(a, v(b, 6)) ? 5 : X(a, v(b, 8)) ? 6 : X(a, v(b, 7)) ? 7 : X(a, v(b, 21)) ? 8 : X(a, v(b, 25)) ? 9 : X(a, v(b, 28)) ? 10 : X(a, v(b, 2)) ? v(b, 18) || X(a, v(b, 3)) ? 2 : 0 : !v(b, 18) && X(a, v(b, 3)) ? 1 : -1 : -1
  }
  ...
  function Oa(a, b, c, d, e) {
    ...
    if (null != b && (f = b.l(), g = "" + f, h = a.toString(), 0 == h.lastIndexOf(g, 0))) {
      var l = new r(h.substring(g.length)),
        h = v(b, 1),
        g = new RegExp(y(h, 2));
      Pa(l, b, null);
      b = l.toString();
      h = y(h, 3);
      if (!P(g, a.toString()) && P(g, b) || 3 == Ma(h, a.toString())) return c.append(b), d && w(e, 6, 10), e.ba(f), f
    }
    e.ba(0);
    return 0
  }
  ...
  function Qa(a, b, c, d) {
    ...
    a: {
      ...
      if (0 <= g && Fa(b.substring(0, g)))
        for (var h = b.match(Aa), l = h.length, n = 1; n < l; ++n)
    ...
    try {
      ...
      if ("Invalid country calling code" == p && O.test(l)) {
        if (l = l.replace(O, ""), h = Oa(l, g, b, d, f), 0 == h) throw p;
      } else throw p;
    }
    ...
    null != g && (a = new r, c = new r(b.toString()), Pa(c, g, a), e = c.toString(), g = v(g, 1), g = y(g, 3), 2 != Ma(g, e) && (b = c, d && w(f, 7, a.toString())));
    d = b.toString();
    a = d.length;
  ...
  */
  ...
  function Ya(a) {
    for (var b = a.h.length, c = 0; c < b; ++c) {
      ...
      if (-1 != h.indexOf("|")) f = !1;
        ...
        n.length < l.b.f.length ? l = "" : (h = n.replace(new RegExp(h, "g"), g), l = h = h.replace(RegExp("9", "g"), l.qa));
        0 < l.length ? (f.q.append(l), f = !0) : f = !1
      }
      if (f) return a.v = e, a.ea = Xa.test(v(d, 4)), a.t = 0, !0
    }
    return a.m = !1
  }
  ...
  function Za(a, b) {
    for (var c = [], d = b.length - 3, e = a.h.length, f = 0; f < e; ++f) {
      var g = a.h[f];
      if (0 == z(g, 3)) c.push(a.h[f]);
      else {
        var h = Math.min(d, z(g, 3) - 1),
          g = v(g, 3, h);
  ...
  function hb(a) {
    for (var b = a.b.toString(), c = a.h.length, d = 0; d < c; ++d) {
      var e = a.h[d],
        f = y(e, 1);
      if ((new RegExp("^(?:" + f + ")$")).test(b)) return a.ea = Xa.test(v(e, 4)), b = b.replace(new RegExp(f, "g"), v(e, 2)), Z(a, b)
    }
    return ""
  }
  ...
  function fb(a) {
    var b = a.b.toString();
    if (3 <= b.length) {
      for (var c = a.s && 0 < z(a.i, 20) ? x(a.i, 20) || [] : x(a.i, 19) || [], d = c.length, e = 0; e < d; ++e) {
        var f = c[e],
          g;
        (g = null == a.i.c[12] || a.s || v(f, 6)) || (g = y(f, 4), g = 0 == g.length || Da.test(g));
        g && (g = y(f, 2), Wa.test(g) && a.h.push(f))
      }
      Za(a, b);
      b = hb(a);
  ...
  function eb(a) {
    ...
    d ? (c = 1, a.d.append("1").append(" "), a.s = !0) : null != a.i.c[15] && (d = new RegExp("^(?:" + v(a.i, 15) + ")"), d = b.match(d), null != d && null != d[0] && 0 < d[0].length && (a.s = !0, c = d[0].length, a.d.append(b.substring(0, c))));
    a.b.clear();
  ...
  function jb(a, b) {
    try {
      ...
      return "Invalid country calling code" == p ? 1 : "The string supplied did not seem to be a phone number" == p ? 4 : "Phone number too short after IDD" == p || "The string supplied is too short to be a phone number" == p ? 2 : "The string supplied is too long to be a phone number" == p ? 3 : -99
    }
  }
  m("intlTelInputUtils", {});
  m("intlTelInputUtils.formatNumberAsYouType", function(a, b, c, d, e) {
    try {
      var f = a.replace(/\D/g, ""),
        g = new Ra(b),
        h = "",
      ...
      for (var n = 0; n < f.length; n++) {
        l = $a(g, f.charAt(n));
        if (d && h && l.length <= h.length && -1 == l.indexOf(" ") && 2 != jb(f.substring(0, n - 1), b)) return h + " ext. " + f.substring(n, f.length);
        h = l
      }
      ...
      if (c && !a.split(" ext. ")[1]) {
        ...
        if (isNaN(parseFloat(p.substr(p.length -
            2, 1)))) return p.substr(0, p.length - 1);
        if (d && h && p.length <= h.length && -1 == p.indexOf(" ") && 2 != jb(f.substring(0, n - 1), b) && !e) return h + " ext. "
      }
      return h
    } catch (kb) {
      return a
  ...
  m("intlTelInputUtils.getValidationError", jb);
